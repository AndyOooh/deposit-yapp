  ...
  wallet: [
    {
      ...
      description: "Send funds from MetaMask",
      sourceType: "wallet",
    ...
    },
    {
      ...
      description: "Send funds from Phantom wallet",
      sourceType: "wallet",
      supportsExtension: true,
      supportsMobile: true,
      link: {
    ...
    },
    {
      ...
      description: "Send funds from Trust Wallet",
      sourceType: "wallet",
    ...
    },
    {
      ...
      description: "Send funds from Coinbase Wallet",
      sourceType: "wallet",
      supportsExtension: true,
      supportsMobile: true,
      link: {
